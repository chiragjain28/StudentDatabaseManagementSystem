...
class RMS:     
    def __init__(self,root):
        ...
        btn_view=Button(self.root,text="View Student Result",font=("goudy old style",15,"bold"),bg="#033054",fg="white",cursor="hand2",command=self.add_report).place(x=325, y=85 ,width=220,height=40)
        btn_attendence=Button(self.root,text="Attendence",font=("goudy old style",15,"bold"),bg="#033054",fg="white",cursor="hand2",command=self.attendence).place(x=580, y=85 ,width=220,height=40)
        btn_logout=Button(self.root,text="Logout",font=("goudy old style",15,"bold"),bg="#033054",fg="white",cursor="hand2",command=self.logout).place(x=835, y=85 ,width=220,height=40)
        btn_exit=Button(self.root,text="Exit",font=("goudy old style",15,"bold"),bg="#033054",fg="white",cursor="hand2",command=self.exit).place(x=1085, y=85 ,width=220,height=40)
